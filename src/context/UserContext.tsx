...
export const AGE_GROUP_CONFIG: Record<AgeGroup, {
  ...
  child: {
    label: "Çocuk (7–12)",
    emoji: "🧒",
    description: "Fairy-tale language, game analogies, very short sentences",
  ...
  teen: {
    label: "Genç (13–18)",
    emoji: "🎓",
    description: "Exam-focused, daily life examples, medium-length sentences",
  ...
  university: {
    ...
    emoji: "🎯",
    description: "Academic but fluid, industry/logical analogies",
